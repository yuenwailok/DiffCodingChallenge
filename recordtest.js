	...
	_createClass(DisplayRecord, [{
		...
		value: function handleSubmit(event) {
			...
			fetch(this.props.address + this.state.value).then(function (response) {
				...
				_this2.setState({ records: recordList(data), jsonObject: data, error: false });
...
ReactDOM.render(React.createElement(DisplayRecord, { address: "https://hiring-task-api.herokuapp.com/v1/leases/" }), document.getElementById('root'));